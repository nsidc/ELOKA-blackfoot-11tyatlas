...
export class Environment {
    ...
    constructor(options) {
        ...
        this.utils.safeString = (str) => this.options.autoescape ? new SafeString(str) : str;
    }
    use(plugin) {
        plugin(this);
    }
    ...
    compileTokens(tokens, outputVar = "__exports.content", closeToken, closeTokenOptional = false) {
        const compiled = [];
        let openToken;
