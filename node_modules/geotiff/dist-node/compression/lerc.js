...
class LercDecoder extends basedecoder_js_1.default {
    decodeBlock(buffer) {
        const addCompression = this.parameters.LercParameters[globals_js_1.LercParameters.AddCompression];
        ...
        const lercResult = lerc_1.default.decode(buffer, { returnPixelInterleavedDims: this.parameters.planarConfiguration === 1 });
